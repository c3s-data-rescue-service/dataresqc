...
```{r, echo=FALSE}
include_graphics("plot_daily.jpg")
```
...
```{r, echo=FALSE}
include_graphics("plot_daily3.jpg")
```
...
```{r, echo=FALSE}
include_graphics("plot_daily3b.jpg")
```
...
```{r, echo=FALSE}
include_graphics("plot_decimals.jpg")
```
...
```{r, echo=FALSE}
include_graphics("climatic_outliers.jpg")
```
...
```{r, echo=FALSE}
include_graphics("climatic_outliers_red.jpg")
```
...
same station you selected before. You can easily download the minimum temperature series by replacing the letter 'x' with the letter 'n' in the filename:

```{r, results="hide"}
climexp_to_sef("http://climexp.knmi.nl/data/ngdcnAR000875850.dat")
...
```{r, echo=FALSE}
include_graphics("plot_subdaily.jpg")
```
